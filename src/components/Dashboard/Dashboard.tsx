...
import { DataTable, ArtistForm } from '../../components';  
...
const myStyles = {
    ...
    content: {
      backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0)), url(${artist_image});`,
      height: '1000px',
      ...
      <Box sx = {{display: 'flex'}}>
          ...
          <AppBar
            ...
            <Toolbar sx= {myStyles.toolbar}>
                ...
                <Button sx={myStyles.toolbarButton} onClick={handleDialogOpen}> Create Famous Artist </Button>
                   {/*Dialog Pop Up begin */}
                <Dialog open={dialogOpen} onClose={handleDialogClose} aria-labelledby="form-dialog-title">
                    <DialogTitle id="form-dialog-title">Add New Artist</DialogTitle>
                    <DialogContent>
                        <DialogContentText>Add A New Artist</DialogContentText>
                        <ArtistForm />
                    </DialogContent>
                    <DialogActions>
